...
export class SecurityService {
     ...
     * @returns {Observable<UserDto>} logged user
     */
    login(username: string, password: string, remember: boolean): Observable<UserDto> {
        return this.http.post<UserDto>(this.contextUrl + '/login', { username: username, password: password })
            .pipe(
